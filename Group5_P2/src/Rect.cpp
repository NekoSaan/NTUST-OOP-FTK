...
// Intent: Set the selection status of the rectangle.
// Pre: None
// Post: The selection status of the rectangle is updated to the specified value.
void Rect::setBeSelect(bool b) {
	this->beSelect = b;
}

// Intent: Get the selection status of the rectangle.
// Pre: None
// Post: Returns the selection status of the rectangle.
